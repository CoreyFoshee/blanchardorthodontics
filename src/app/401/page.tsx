// Pixel-perfect migration of 401.html to Next.js React page
        ...
        <div className="banner-area-title">
          <div className="container w-container">
            <div className="title-area-content">
              <h1 className="banner-title-text">Protected Page</h1>
            </div>
          </div>
        </div>
      </div>
      <div className="protected-page-wrap">
        <div className="protected-form-wrap w-password-page w-form">
          <div className="section-title-area center-align">
            <div className="sub-title-wrap center-align"><img src="/images/subtitle-separator.svg" loading="lazy" alt="Sub Title Icon " />
              <h1 className="sub-title-text center-subtitle">enter password</h1><img src="/images/subtitle-separator.svg" loading="lazy" alt="Sub Title Icon " />
            </div>
            <h2 className="section-title center">Protected Page!</h2>
            <div className="section-title-content minimal-padding">This page is password protected. If you are the website admin, or have access <br />to this page, please type your password below.</div>
          </div>
          <form action="/.wf_auth" method="post" id="email-form" name="email-form" data-name="Email Form" className="utility-page-form container w-password-page" data-wf-page-id="6512cf86865dd3d45d6608a6" data-wf-element-id="613b3a2cc5ea7c2e5303a24e00000000000c">
            <div className="input-block password"><img src="/images/password-key.svg" loading="lazy" alt="Form User Icon" className="form-icon" /><input className="form-input-field protected-page w-password-page w-input" maxLength={256} name="pass" data-name="field" placeholder="Enter your password" type="password" id="pass" /></div><input type="submit" data-wait="Please wait..." className="button w-password-page w-button" value="Submit Now" />
            <div className="error-message w-password-page w-form-fail">
              <div className="form-error-text">Incorrect password. Please try again.</div>
            </div>
            <div style={{display:'none'}} className="w-password-page w-embed w-script"><input type="hidden" name="path" value="<%WF_FORM_VALUE_PATH%>" /><input type="hidden" name="page" value="<%WF_FORM_VALUE_PAGE%>" /></div>
            <div style={{display:'none'}} className="w-password-page w-embed w-script">
              <script type="application/javascript" dangerouslySetInnerHTML={{
                __html: `(function _handlePasswordPageOnload() {
