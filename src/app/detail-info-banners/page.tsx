// Pixel-perfect migration of detail_info-banners.html to Next.js React page
// All class names, structure, and content are preserved
// All image paths updated to /images/...

export default function DetailInfoBannersPage() {
  return (
    <>
      ...
      <div className="info-banner-detail-content">
        <div className="container w-container">
